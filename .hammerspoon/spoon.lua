...
hsreload_keys = hsreload_keys or {hypershift, "R"}
...
if spoon.HSaria2 then
    ...
    hsaria2_keys = hsaria2_keys or {hypershift, "L"}
...
if spoon.KSheet then
    ...
    hscheats_keys = hscheats_keys or {hypershift, "S"}
    ...
    spoon.ModalMgr.supervisor:bind(
        ...
        function()
            ...
            if #safari_running > 0 then
                local stat,
                    data = hs.applescript('tell application "Safari" to get {URL, name} of current tab of window 1')
                if stat then
